...
const { Decimal, decodeUtf8, IonTypes, makePrettyWriter, makeReader, Timestamp, toBase64 } = require('ion-js');
...
class Util {
    ...
    blockResponseToString(blockResponse) {
        let stringBuilder = "";
    ...
    digestResponseToString(digestResponse) {
        let stringBuilder = "";
